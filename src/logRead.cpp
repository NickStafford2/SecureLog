...
//   if (argc == 5) {
//     assert(std::strcmp(argv[1], "-K") == 0 && std::strcmp(argv[3], "-S") ==
//     0); std::cout << "Argument content check successful!" << std::endl;
//   } else if (argc == 7) {
//     assert(
//         std::strcmp(argv[1], "-K") == 0 && std::strcmp(argv[3], "-R") == 0 &&
//         (std::strcmp(argv[4], "-E") == 0 || std::strcmp(argv[4], "-G") ==
//         0));
...
// }
//
// // processArgument prints all the names of employees and guests that went to
// the
