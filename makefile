...
SHARED_OBJS := $(OBJ_DIR)/crypto.o $(OBJ_DIR)/inputValidation.o $(OBJ_DIR)/logAppendArgs.o $(OBJ_DIR)/logReadArgs.o $(OBJ_DIR)/gallery.o $(OBJ_DIR)/participantType.o $(OBJ_DIR)/event.o
