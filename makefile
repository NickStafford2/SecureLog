...
SHARED_OBJS := $(OBJ_DIR)/crypto.o $(OBJ_DIR)/inputValidation.o $(OBJ_DIR)/inputValidationLogAppend.o $(OBJ_DIR)/inputValidationLogRead.o $(OBJ_DIR)/state.o $(OBJ_DIR)/event.o
